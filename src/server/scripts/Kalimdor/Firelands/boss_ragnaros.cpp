...
/*
Script:     Ragnaros Cataclysm Encounter
Complete:   10 NHC: 90%, 10HC: 80%
Autor:      Northstrider

Notes:      This is an censored beta version of my Ragnaros
            code. This means that i removed some mechanics and fixes
            to prevent the usage for servers (because it would kill the players).
            So you got an optimal base code to complete if you know C++.
            Have fun with fixing the compile for the latest TC revision ;)
*/
